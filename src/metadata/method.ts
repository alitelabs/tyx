...
import { HttpMetadataInfo } from "./http";
...
export interface MethodMetadata {
    ...
    roles: Roles;
    args: MethodTypeInfo[];
    returns: MethodTypeInfo;
    http?: HttpMetadataInfo;
}
...
export namespace MethodMetadata {
    ...
    export function define(target: Object, propertyKey: string, descriptor?: PropertyDescriptor): MethodMetadata {
        ...
        meta.args = [];
        types.forEach((type, i) => meta.args[i] = { name: names[i], type: type.name, constructor: type });
