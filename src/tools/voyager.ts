const { voyagerVersion } = require('../../package.json');

const version = voyagerVersion || 'latest';
...
export interface DisplayOptions {
  ...
  skipRelay?: boolean;
  /** [string] - name of the type to be used as a root */
  rootType?: string;
  /** [boolean, default false] - sort fields on graph by alphabet] */
  sortByAlphabet?: boolean;
  /** [boolean, default false] - hide the docs sidebar */
  hideDocs?: boolean;
  /** [boolean, default false] - hide the root type */
  hideRoot?: boolean;
}

export function renderVoyagerPage(options: MiddlewareOptions) {
